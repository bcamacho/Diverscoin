...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s diverscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  diverscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diverscoin transaction") + "\n" +
              "  diverscoin-tx [options] -create [commands]   " + _("Create hex-encoded diverscoin transaction") + "\n" +
              "\n";
