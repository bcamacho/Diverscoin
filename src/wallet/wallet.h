...
enum WalletFeature
{
    FEATURE_BASE = 000100, // the earliest version new wallets supports (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 00001, // wallet encryption
    FEATURE_COMPRPUBKEY = 00001, // compressed public keys

    FEATURE_HD = 00001, // Hierarchical key derivation after BIP32 (HD Wallet)
