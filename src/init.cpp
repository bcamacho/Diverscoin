...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/diverscoin-project/diverscoin>";
    const std::string URL_WEBSITE = "<https://diverscoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Diverscoin version %s\n", FormatFullVersion());
}
